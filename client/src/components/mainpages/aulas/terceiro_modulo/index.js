      ...
      <div class="container">
        ...
        <div class="row text-center text-lg-left">
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            ...
            {/* FORMULARIO */}
            {/* <footer>
              <p class="text-center"><a href="https://forms.gle/gfBQBSTUofKAKw4k7"><button type="button" class="btn mt-4" style={{ backgroundColor: '#d70000', color:'#fff' }}>Formulário Aula 2</button></a></p>
            </footer> */}
          </div>
          {/* <!--Fim modal 2--> */}
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            ...
            {/* FORMULARIO */}
            <footer>
              <p class="text-center"><a href="https://forms.gle/YeRMvDs32MYyHCg18"><button type="button" class="btn mt-4" style={{ backgroundColor: '#d70000', color:'#fff' }}>Formulário Aula 9</button></a></p>
            </footer>
          </div>
          {/* <!--Fim Modal 9--> */}
