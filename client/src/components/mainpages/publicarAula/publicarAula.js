...
function PublicarAula() {
    ...
    const [aula, setAula] = useState(initialState)
    ...
    const handleUpload = async e => {
        ...
        try {
            ...
            if (file.type !== 'image/jpeg' && file.type !== '.mp4') // 1mb
